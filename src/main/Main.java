...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        menu.addeventMenuSelectted(new eventMenuSelected() {
            @Override
            public void selected(int index) {
                System.out.println(index);
                if (index == 0) {
                   setForm(new Form_Home());// gọi form 
               }else  if (index == 1) {
                   setForm(new Form_SP());// gọi form 
               } else if (index == 2) {
                  setForm(new Form_BanHang());// gọi form
              } else if (index == 3) {
                  setForm(new form2());// gọi form
                } 
           }

        });
        setForm(new Form_Home());//đặt form home mặc định khi mở lên
    }
        ...
        panelBorder1Layout.setHorizontalGroup(
            ...
            .addGroup(panelBorder1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(header2, javax.swing.GroupLayout.DEFAULT_SIZE, 1308, Short.MAX_VALUE)
                    .addGroup(panelBorder1Layout.createSequentialGroup()
                        .addGap(6, 6, 6)
